...
(define sort-by-depth
  (lambda (table)
    (sort table depth>?))) ; TODO different argument order in scheme
...
(define sym-t (list (list (gensym) 'alpha) (list (gensym) 'beta) (list (gensym) 'charlie)))
(define cnt-t (list (list 1 'alpha) (list 3 'beta) (list 1 'charlie)))
